...
class VehicleSeatSelectionBloc extends StatelessWidget {
  ...
  const VehicleSeatSelectionBloc({
    super.key,
...
class VehicleSeatSelectionView extends StatefulWidget {
  ...
  @override
  State<VehicleSeatSelectionView> createState() => _VehicleSeatSelectionViewState();
}
